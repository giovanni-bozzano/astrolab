	...
	<div id="about-page" class="page">
		<div class="grid-container">
			...
			<div class="grid-x grid-padding-x">
				...
				<div class="cell large-3 medium-4 small-6">
					<div class="team-member">
						<img class="team-image" src="/img/about/giulia_di_rienzo.jpg" alt="Giulia Di Rienzo"/>
				...
				<div class="cell large-3 medium-4 small-6">
					<div class="team-member">
						<img class="team-image" src="/img/about/francesca_musiari.jpg" alt="Francesca Musiari"/>
				...
				<div class="cell large-3 medium-4 small-6">
					<div class="team-member">
						<img class="team-image" src="/img/about/giulia_grazia_napolitano.jpg" alt="Giulia Grazia Napolitano"/>
				...
				<div class="cell large-3 medium-4 small-6">
					<div class="team-member">
						<img class="team-image" src="/img/about/anna_canali.jpg" alt="Anna Canali"/>
						<h2>Anna Canali</h2>
				...
				<div class="cell large-3 medium-4 small-6">
					<div class="team-member">
						<img class="team-image" src="/img/about/marta_borrini.jpg" alt="Marta Borrini"/>
						<h2>Marta Borrini</h2>
						<h3>Amministrazione</h3>
				...
				<div class="cell large-3 medium-4 small-6">
					<div class="team-member">
						<img class="team-image" src="/img/about/rocco_punghellini.jpg" alt="Rocco Punghellini"/>
			...
			<footer class="hide-for-medium"><p>Per qualsiasi informazione // <a href="mailto:progettoastrolab@gmail.com" target="_blank" rel="noopener">progettoastrolab@gmail.com</a>, <a href="https://www.facebook.com/progettoastrolab/" target="_blank" rel="noopener">Facebook</a>, <a href="https://www.instagram.com/progettoastrolab/" target="_blank" rel="noopener">Instagram</a></p></footer>
		</div>
	</div>
</template>