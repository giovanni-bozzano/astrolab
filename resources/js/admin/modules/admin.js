	...
	actions: {
		...
		*/
		editPoi({ commit, state, dispatch }, data) {
			...
			AdminAPI.editPoi(data.id, data.name, data.image, data.description, data.address, data.coordinates, data.email_address, data.phone_number, data.website, data.hashtag, data.category_id, data.latitude, data.longitude).then(function(response) {
		...
		*/
		publishNewPoi({ commit, state, dispatch }, data) {
			...
			AdminAPI.publishNewPoi(data.name, data.image, data.description, data.address, data.coordinates, data.email_address, data.phone_number, data.website, data.hashtag, data.category_id, data.latitude, data.longitude, data.suggestion_id).then(function(response) {
				commit('setNotificationText', response.data);
